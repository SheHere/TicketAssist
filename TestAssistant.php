...
<div class="container-fluid text-center"> <!-- Creates container that holds everything except the navbar-->
  <div class="row content">
    ...
    <div class="col-md-2 text-left">
      <form id="clientInfoForm" method="post" action="testInfoOutput.php" target="infoiFrame">
			<!-- Begin client info section-->
			 <fieldset id="clientinfo">
			  <legend>Client Information:</legend>
				<div class="form-group">
					<label for ="clientusername">Username: (Check in FIM / WHD)</label>
					<input type="text" class="form-control" name="clientusername" autofocus>
				</div>
				<!--
				<div class="form-group">
			 ...
			 <fieldset id="details">
			  <legend>Further Details:</legend>
				<div class="form-group">
					<select required class="form-control" id="typeselect" name="typeselect" > <!-- When changed, calls selection.js -->
						<option value="">---</option>
						<option id="none" value="None Applicable">None Applicable</option>
	...
	<div class="col-md-2 text-left">
		...
		<div class="row" >
			<div class="col-md-12 col-sm-12" >
				<input id="submitbutton" type="submit" class="btn btn-custom" value="Populate Editor">
			</div>
		</div>
		</form> <!--end of form-->
	...
	--->
		<div class="row">
			<div class="infoiFrame" id="infoiFrameDiv" >
				<iframe src="testInfoOutput.php" name="infoiFrame" width="100%" height="257px" frameBorder="0" marginwidth="0px" scrolling="no"></iframe>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12 col-sm-12">
		...
		<div id="home_tabs">
		  ...
		  <div class="tab-content">
			...
			<div id="logs" class="tab-pane fade">
			  <iframe id="logiFrame"  name="logiFrame" width="100%" height="690px" frameBorder="0" src="logs/miniLogIndex.php"></iframe>
			</div>
			...
			<div id="genresp" class="tab-pane fade">
			  <iframe style="padding-top: 3px;" name="genrespiFrame" width="100%" height="690px" frameBorder="0" src="genericresponses/ShowGenericResponses.php"></iframe>
			</div>
	...
	--->
	<div class="col-md-3 text-left"><!-- 1 size taken from sidenav, which is commented out righ now-->
		<div id="right_tabs">
		  <ul class="nav nav-tabs">
			<li class="active"><a data-toggle="tab" href="#srvstatus">Services Status</a></li>
			<li><a data-toggle="tab" href="#twitter">Twitter</a></li>
			<li><a data-toggle="tab" href="#contact">Contact Info</a></li>
		  </ul>

		  <div class="tab-content">
			<div id="srvstatus" class="tab-pane fade in active">
			  <iframe style="padding-top: 3px;" name="srvstatusiFrame" width="100%" height="690px" frameBorder="0" src="Services.php"></iframe>
			</div>
			...
			<div id="contact" class="tab-pane fade">
				<iframe style="padding-top: 3px;" name="contactiFrame" width="100%" height="690px" frameBorder="0" src="includes/contactinfo.php" marginwidth="0px"></iframe>
			</div>
		  </div>
		</div>

	</div> <!-- End div for columns 11-12 -->
