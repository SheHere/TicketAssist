...
<?php		 
	...
	if(!$result) {
		...
		echo '<script> parent.errorAlert("'. mysqli_error($con) .'","https://140.209.47.120/dev/SubmitBug.php");</script>';
	} else {
		echo '<script> parent.successAlert("Feedback for:'.$url.' has been received.","http://140.209.47.120/assistant.php"); </script>';
		$recipient = "sche0210";
		$title = 'New Feedback Submitted';
		$message = 'Feedback has been submitted by: <strong>'.$submittedBy.'</strong>. View it <a href="https://140.209.47.120/dev/ViewBugs.php">here</a>.';
		$all_tier = 0;
