...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-md-10 text-left">
		...
		<h1>Active Feedback Submissions</h1>
		...
		-->
		<form id="feedbackForm" action="resolveFeedback.php" method="post" target="iFrame">
			<table id="feedbackTable" class="display table table-striped">
				<thead>
					<tr>
						<th>Submitted By</th>
						<th>URL</th>
				...
				*/
					...
					$output = "";
					$sql = "SELECT id, submitted_by, url, note, status, fname, lname FROM bugs, users WHERE `bugs`.`submitted_by` LIKE `users`.`username` ";
