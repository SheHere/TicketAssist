		...
		<div class="col-md-10 text-left">
			...
			<div id="user_tabs">
				<ul class="nav nav-tabs">
					<li <?php if(strcmp('new',$_GET['tab']) != 0){echo 'class="active"';} ?>><a data-toggle="tab" href="#table">Contact Table</a></li>
					<li <?php if(strcmp('new',$_GET['tab']) == 0){echo 'class="active"';} ?>><a data-toggle="tab" href="#new">New Contact</a></li>
				</ul>
				<br>
				<div class="tab-content">
					<div id="table" class="tab-pane fade <?php if(strcmp('new',$_GET['tab']) != 0){echo 'in active';} ?>">
						<!-- 
									...
									if (mysqli_num_rows($result) > 0) {
										...
										while($row = mysqli_fetch_assoc($result)) {
											...
											if($grouping == 1 || $grouping == 0) {
												$grouping_text = "Tech Desk";
											} else if($grouping == 2) {
												$grouping_text = "RRT";
											} else if($grouping == 3) {
												$grouping_text = "EDT";
											} else if($grouping == 4) {
												$grouping_text = "Local Tech";
											} else if($grouping == 5) {
												$grouping_text = "Other";
											} else if($grouping == -1) {
												$grouping_text = "Hidden";
											}
											/*
					...
					<div id="new" class="tab-pane fade<?php if(strcmp('new',$_GET['tab']) == 0){echo 'in active';} ?>">
						<form id="contactUpdateForm" action="modifyContactEntry.php" method="post" target="contactiFrame">
							...
							<div class="form group">
								...
								<select class="form-control" name="selectGrouping" required>
									<option value="">----</option>
									<option value="1">Tech Desk</option>
									<option value="2">RRT</option>
									<option value="3">EDT</option>
									<option value="4">Local Techs</option>
