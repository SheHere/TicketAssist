...
if (isset($_SESSION["username"])) {
	header("Location: https://tdta.stthomas.edu/assistant/assistant.php");
}
				...
				<ul class='login_failed'>
		            ...
		            <li>
		         	...
		         	<li id='request_access_container'>
						<a id='request_access' class='request_access' href='RequestAccess.php'>Don't have an account?<br>Request Access</a>
					</li>
                    <li id='wiki-link-container'>
                        <a id='wiki-link' href='wiki' class='request_access'><span class='glyphicon glyphicon-arrow-left'></span> Visit the TDTA Tech Wiki!</a>
                    </li>
		         </ul>
		        </form>
			</div>";
...
<?php } ?>
<p id="browser-notice"><i>Optimized for Chrome and Firefox</i></p>
