        ...
        <div class="row grouprow" style="margin-bottom: 15px;">
            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                <div class="btn-group" role="group">
                    <a target="_self" href="https://tdta.stthomas.edu/genericresponses/ShowResponses.php" class="btn btn-default"><span style="color: black;" class="glyphicon glyphicon-remove"></span> - Cancel</a> 
                </div>
                <div class="btn-group" role="group">
					...
					<div class="panel-heading">
						<h4 class="panel-title">
                            ...
                            <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                <div class="input-group-addon removeBtn"><a ' . $btnQualifier . 'class="btn btn-link sidebtn" onclick="parent.confirmDelete(\'https://tdta.stthomas.edu/assistant.php\', \'https://tdta.stthomas.edu/genericresponses/deleteRespGroup.php\', ' . $group_id . ');"><span class="glyphicon glyphicon-remove"></span></a></div>
